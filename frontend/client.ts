 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { create as api_payment_create_create } from "~backend/payment/create";
import { dashboard as api_payment_dashboard_dashboard } from "~backend/payment/dashboard";
import { get as api_payment_get_get } from "~backend/payment/get";
import { list as api_payment_list_list } from "~backend/payment/list";
import { updateStatus as api_payment_update_status_updateStatus } from "~backend/payment/update_status";
import {
    createUser as api_payment_user_management_createUser,
    deleteUser as api_payment_user_management_deleteUser,
    getUserStats as api_payment_user_management_getUserStats,
    updateUser as api_payment_user_management_updateUser
} from "~backend/payment/user_management";
import { listUsers as api_payment_users_listUsers } from "~backend/payment/users";
...
export namespace payment {
    ...
    export class ServiceClient {
         ...
         */
        public async create(params: RequestType<typeof api_payment_create_create>): Promise<ResponseType<typeof api_payment_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/payment-orders`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_payment_create_create>
        }

        /**
         * Creates a new user (admin only).
         */
        public async createUser(params: RequestType<typeof api_payment_user_management_createUser>): Promise<ResponseType<typeof api_payment_user_management_createUser>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/admin/users`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_payment_user_management_createUser>
        }

        /**
         * Retrieves dashboard statistics and data.
         */
        public async dashboard(): Promise<ResponseType<typeof api_payment_dashboard_dashboard>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/dashboard`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_payment_dashboard_dashboard>
        }
        ...
        public async deleteUser(params: { id: number }): Promise<void> {
            await this.baseClient.callTypedAPI(`/admin/users/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
        }

        /**
         * Retrieves a payment order with full details including history, attachments, and items.
         */
        public async get(params: { id: number }): Promise<ResponseType<typeof api_payment_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/payment-orders/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_payment_get_get>
        }

        /**
         * Gets user statistics (admin only).
         */
        public async getUserStats(): Promise<ResponseType<typeof api_payment_user_management_getUserStats>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/admin/users/stats`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_payment_user_management_getUserStats>
        }

        /**
         * Retrieves all payment orders with optional filtering.
         */
        public async list(params: RequestType<typeof api_payment_list_list>): Promise<ResponseType<typeof api_payment_list_list>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                department: params.department === undefined ? undefined : String(params.department),
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/payment-orders`, {query, method: "GET", body: undefined})
         ...
         * Retrieves all users.
         */
        public async listUsers(): Promise<ResponseType<typeof api_payment_users_listUsers>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/users`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_payment_users_listUsers>
        }

        /**
         * Updates the status of a payment order.
         */
        public async updateStatus(params: RequestType<typeof api_payment_update_status_updateStatus>): Promise<ResponseType<typeof api_payment_update_status_updateStatus>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/payment-orders/${encodeURIComponent(params.id)}/status`, {method: "PUT", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_payment_update_status_updateStatus>
        }

        /**
         * Updates an existing user (admin only).
         */
        public async updateUser(params: RequestType<typeof api_payment_user_management_updateUser>): Promise<ResponseType<typeof api_payment_user_management_updateUser>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
                email:    params.email,
                name:     params.name,
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_payment_user_management_updateUser>
        }
    }
}
