...
```bash
git remote add encore encore://payment-order-approval-system-uc92
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/payment-order-approval-system-uc92/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/payment-order-approval-system-uc92/settings/integrations/github)
